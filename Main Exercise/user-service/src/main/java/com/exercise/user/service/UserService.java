...
import com.exercise.user.ValueObjects.Department;
...
public class UserService {
	...
	public User saveUser(User user) {
		log.info("Inside saveUser method from User service Class");
		return userRepository.save(user);
	}

	public ResponseTemplateVO getUserWithDepartment(Long userId) {
		log.info("Inside getUserWithDepartment method from User service Class");
